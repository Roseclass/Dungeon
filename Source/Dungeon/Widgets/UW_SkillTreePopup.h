...
DECLARE_MULTICAST_DELEGATE_TwoParams(FPopupButtonClicked, int32, ASkillActor*);
...
public:
	...
	FORCEINLINE void SetSkillActor(ASkillActor* InSkillActor) { SkillActor = InSkillActor; }
};
